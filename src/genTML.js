...
const genEngineer = function (engineer) {
    ...
    <div class="col-4 mt-4">
        <div class="card h-100">
            ...
            <li class="office list-group-item">Github: <a href="https://github.com/${engineer.github}">${engineer.github}</a></li>
            </div>
        </div>
    </div>
    `
...
const genIntern = function (intern) {
    ...
    <div class="col-4 mt-4">
        <div class="card h-100">
            ...
            <li class="office list-group-item">School: ${intern.school}</li>
            </div>
    </div>
</div>
    `
